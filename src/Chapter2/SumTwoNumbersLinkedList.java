...
public class SumTwoNumbersLinkedList {
	...
	public SumTwoNumbersLinkedList(LinkedList<Integer> list1, int len1, LinkedList<Integer> list2, int len2){
		this.fList = list1;
		this.sList = list2;
		...
		if(this.fList.isEmpty() && this.sList.isEmpty()){
			...
			if(this.fList.isEmpty() && !this.sList.isEmpty()){
				...
				if(!this.fList.isEmpty() && this.sList.isEmpty()){
					...
					for(countL1 = 0, countL2 = 0; countL1 < this.length1 && countL2 < this.length2; countL1++, countL2++){

						int val1 = (int) Math.pow(10, countL1) * (nodeL1.value) ;	
						int val2 = (int) Math.pow(10, countL2) * (nodeL2.value);
						int resVal = 0;

						//System.out.println(countL1 + " :" + val1 + " " + val2 + " = " + (val1 + val2));
						if(countL1 == 0){
							...
							if(resVal == Math.pow(10,1)){									
								...
								//System.out.println("\tResVal " + newResVal);
						...
						//System.out.println(countL1 + " :" + " append " + resVal + "  Carry =" + carry);
